/**
 * Shared translation / publish quality checks.
 * Used by the translation worker (READY gating) and CMS pre-publish validation.
 */
...
/** Strip HTML tags for quality scans. */
...
/**
 * Pre-publish checks: READY-but-implausible translations, empty blocks, gibberish.
 */
...
/** Drop empty paragraphs and empty collages from a body array. */
