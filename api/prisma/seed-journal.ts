...
const ARTICLES: SeedArticle[] = [
  ...
  {
    slug: 'vidin-library-evening',
    section: 'news',
    categoryBg: 'Новини',
    categoryEn: 'News',
    titleBg: 'Вечер на четенето във Видин',
    titleEn: 'Reading evening in Vidin',
    subtitleBg: 'Местни автори споделят страници за реката и паметта.',
    subtitleEn: 'Local authors share pages about the river and memory.',
    readTimeBg: '3 мин',
    readTimeEn: '3 min',
    locationBg: 'Видин',
    locationEn: 'Vidin',
    ...
    dateEn: 'August 2026',
    authorSlug: 'albena-nikolova',
    imageKey: 'seed/news-library',
    imageUrl: '/meseum.jpg',
    body: paragraphs([
      [
        'The municipal library opens late for a quiet evening of regional reading.',
        'Общинската библиотека остава отворена късно за тиха вечер с регионално четене.',
      ],
    ]),
  },
  {
    slug: 'lom-riverside-cleanup',
    section: 'news',
    categoryBg: 'Новини',
    categoryEn: 'News',
    titleBg: 'Почистване на брега в Лом',
    titleEn: 'Riverside cleanup in Lom',
    subtitleBg: 'Доброволци и ученици връщат блясъка на крайречната алея.',
    subtitleEn: 'Volunteers and students restore the riverside walk.',
    readTimeBg: '2 мин',
    readTimeEn: '2 min',
    locationBg: 'Лом',
    locationEn: 'Lom',
    ...
    dateEn: 'August 2026',
    authorSlug: 'inna-gerova',
    imageKey: 'seed/news-lom',
    imageUrl: '/river.jpg',
    body: paragraphs([
      [
        'Bags fill before noon — plastic, bottles, and stories exchanged between shifts.',
        'Торбите се пълнят още преди обяд — пластмаса, бутилки и разговори между смените.',
      ],
    ]),
  },
  {
    slug: 'belogradchik-school-exhibition',
    section: 'news',
    categoryBg: 'Новини',
    categoryEn: 'News',
    titleBg: 'Ученическа изложба в Белоградчик',
    titleEn: 'Student exhibition in Belogradchik',
    subtitleBg: 'Млади фотографи показват скалите през своя обектив.',
    subtitleEn: 'Young photographers show the rocks through their lens.',
    readTimeBg: '3 мин',
    readTimeEn: '3 min',
    locationBg: 'Белоградчик',
    locationEn: 'Belogradchik',
    ...
    dateEn: 'July 2026',
    authorSlug: 'angelika-petrova',
    imageKey: 'seed/news-belogradchik',
    imageUrl: '/forest.jpg',
    body: paragraphs([
      [
        'Classroom walls become a gallery — red stone, morning mist, and first bylines.',
        'Стените на класната стая стават галерия — червен камък, утринна мъгла и първи подписи.',
      ],
    ]),
  },
  {
