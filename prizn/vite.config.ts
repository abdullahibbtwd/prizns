...
import { prizniSeoShellPlugin } from './vite.seo-plugin.ts'
...
export default defineConfig(({ mode }) => {
  ...
  const apiOrigin = `http://localhost:${env.API_PORT || 3003}/api`

  return {
    plugins: [react(), tailwindcss(), prizniSeoShellPlugin(apiOrigin)],
